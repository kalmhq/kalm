...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ComponentTemplateEnvVar) DeepCopyInto(out *ComponentTemplateEnvVar) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ComponentTemplateEnvVar.
func (in *ComponentTemplateEnvVar) DeepCopy() *ComponentTemplateEnvVar {
	if in == nil {
		return nil
	}
	out := new(ComponentTemplateEnvVar)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ComponentTemplateSpec) DeepCopyInto(out *ComponentTemplateSpec) {
	*out = *in
	if in.Env != nil {
		in, out := &in.Env, &out.Env
		*out = make([]ComponentTemplateEnvVar, len(*in))
		copy(*out, *in)
	}
	if in.Command != nil {
		in, out := &in.Command, &out.Command
