...
import { selfManaged, CertificateForm } from "types/certificate";
...
class CertificateUploadFormRaw extends React.PureComponent<Props, State> {
  ...
  private renderSelfManagedFields = (formikProps: FormikProps<CertificateForm>) => {
  ...
  private validate = async (values: CertificateForm) => {
    let errors: any = {};
