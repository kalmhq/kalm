...
// +kubebuilder:webhook:path=/mutate-core-kapp-dev-kapp-dev-v1alpha1-application,mutating=true,failurePolicy=fail,groups=core.kapp.dev.kapp.dev,resources=applications,verbs=create;update,versions=v1alpha1,name=mapplication.kb.io
...
// +kubebuilder:webhook:verbs=create;update,path=/validate-core-kapp-dev-kapp-dev-v1alpha1-application,mutating=false,failurePolicy=fail,groups=core.kapp.dev.kapp.dev,resources=applications,versions=v1alpha1,name=vapplication.kb.io
