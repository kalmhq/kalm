...
export const createConfigAction = (config: Config): ThunkResult<Promise<void>> => {
...
export const duplicateConfigAction = (config: Config): ThunkResult<Promise<void>> => {
...
export const updateConfigAction = (config: Config): ThunkResult<Promise<void>> => {
  return async dispatch => {
    dispatch({
      type: UPDATE_CONFIG,
      payload: { config }
...
export const deleteConfigAction = (config: Config): ThunkResult<Promise<void>> => {
  return async dispatch => {
