...
kubectl apply -f https://raw.githubusercontent.com/kalmhq/kalm/v0.1.0-rc.1/kalm-install-operator.yaml
...
do
  ...
  kubectl apply -f https://raw.githubusercontent.com/kalmhq/kalm/v0.1.0-rc.1/kalm-install-kalmoperatorconfig.yaml
